                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul>
                            @foreach($fases as $f)
                                @if($f->estado==0)
                                <li class="mt-4">{{$f->nombre}}</li>
                                @elseif($f->estado==1)
                                <li class="mt-4">{{$f->nombre}}<span class="float-right" style="color: #005c7c;border: #005c7c solid 1px;padding: 0.1rem;width: 70px;text-align: center;border-radius: 1000px;">Activa</span></li>
                                @elseif($f->estado==2)
                                <li class="mt-4">{{$f->nombre}}<span class="float-right" style="color: #e86727;border: #e86727 solid 1px;padding: 0.1rem;width: 85px;text-align: center;border-radius: 1000px;">Terminada</span></li>
                                @endif
                            @endforeach
                        </ul>
                    </div>
